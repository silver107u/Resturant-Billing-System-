...
public class AddCategoryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAddCategory.setBackground(new java.awt.Color(22, 127, 84));
    ...
    private void btnAddCategoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCategoryActionPerformed
        
        {
           try
           {
            ...
            if(CategoryDao.addProduct(cat_id,c_name).equals("present"))
            {
                JOptionPane.showMessageDialog(null,"Category already present","Success",JOptionPane.INFORMATION_MESSAGE);
                return;
                
            }
            if(CategoryDao.addProduct(cat_id,c_name).equals("true"))
